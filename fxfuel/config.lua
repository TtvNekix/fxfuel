...
Config.Strings = {
	...
	EToRefuel = "Presiona ~g~E ~w~para repostar el vehiculo",
...
if not Config.UseESX then
	Config.Strings.PurchaseJerryCan = "Press ~g~E ~w~para comprar un bidon"
	Config.Strings.RefillJerryCan = "Press ~g~E ~w~para rellenar el bidon"
end
